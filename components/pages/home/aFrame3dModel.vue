...
.aframe-wrapper
  a-scene(vr-mode-ui="enabled: false" embedded
    ...
    a-entity(animation="property: rotation; to: 0 -360 0; loop: true; dur: 50000; easing: linear")
      a-entity(gltf-model="url(/3dmodel.glb)" position="3 0 0" animation-mixer modify-materials animation="property: rotation; to: 0 360 0; loop: true; dur: 50000")
      a-entity(gltf-model="url(/3dmodel-2.glb)" position="-4 -1 0" animation-mixer modify-materials animation="property: rotation; to: 0 -360 0; loop: true; dur: 40000")
    ...
    a-entity#logo(scale="5 5 0")
      a-plane(position="0 0 0" material="src: /HSDF-Logo-2022.png; transparent: true; side: front; depthTest: true")
      a-plane(position="0 0 0" rotation="0 180 0" material="src: /HSDF-Logo-2022.png; transparent: true; side: front; depthTest: true")
    ...
    a-entity(light="type: directional; color: #FFF; intensity: 0.7" position="0 1.6 0")
